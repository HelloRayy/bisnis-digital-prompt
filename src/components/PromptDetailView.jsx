                    ...
                    {!isUnlocked && isPremium && (
                      <div className="absolute inset-0 bg-white/95 backdrop-blur-md flex flex-col items-center justify-center p-4 text-center gap-4 rounded-2xl border border-zinc-200 pointer-events-none my-auto">
                        ...
                        <motion.button
                          ...
                          onClick={handleCopyText}
                          className="group relative inline-flex items-center justify-between pl-6 sm:pl-7 pr-2 py-2 h-12 rounded-full bg-gradient-to-b from-zinc-800 to-zinc-950 hover:bg-white text-white hover:text-obsidian text-sm font-bold border border-white/15 hover:border-zinc-300 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.22),0_2px_4px_0_rgba(0,0,0,0.4)] hover:shadow-xl active:shadow-xs transition-all duration-300 cursor-pointer pointer-events-auto overflow-hidden select-none"
                        >
                          <span className="relative inline-flex items-center justify-center overflow-hidden">
                            ...
                            <span className="transition-all duration-300 group-hover:-translate-y-8 group-hover:opacity-0 group-active:scale-95 font-bold tracking-tight">
                            ...
                            <span className="absolute inset-0 flex items-center justify-center transition-all duration-300 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 font-bold whitespace-nowrap group-active:scale-95 tracking-tight">
                              Buka & Salin Sekarang
                            </span>
                          </span>

                          <div className="w-8 h-8 rounded-full bg-white text-obsidian group-hover:bg-obsidian group-hover:text-white group-active:scale-85 flex items-center justify-center shrink-0 ml-4 relative overflow-hidden transition-all duration-300 shadow-2xs">
